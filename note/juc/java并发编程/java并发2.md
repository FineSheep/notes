...
1. 初始状态， t 线程刚开始从主内存读取了 run 的值到工作内存。
   1. ![1594646434877](http://bodiegu.lsgdut.fun/20200713222445-555075.png)
2. 因为t1线程频繁地从主存中读取run的值，jit即时编译器会将run的值缓存至自己工作内存中的高速缓存中，减少对主存中run的访问以提高效率
   1. ![1594646562777](http://bodiegu.lsgdut.fun/20200713212457-709749.png)
3.  1 秒之后，main 线程修改了 run 的值，并同步至主存，而 t 是从自己工作内存中的高速缓存中读取这个变量
   的值，结果永远是旧值
   1. ![1594646581590](http://bodiegu.lsgdut.fun/20200713212306-584613.png)
...
![1594698374315](http://bodiegu.lsgdut.fun/20200714114615-934315.png)
...
2. 读屏障会确保指令重排序时，不会将读屏障之后的代码排在读屏障之前
   ...
   ![1594698559052](http://bodiegu.lsgdut.fun/20200714114921-56542.png)
...
![1594698671628](http://bodiegu.lsgdut.fun/20200714115112-322421.png)
...
![1594701748458](http://bodiegu.lsgdut.fun/20200714124230-412629.png)
...
![1594703228878](http://bodiegu.lsgdut.fun/20200714130925-543886.png)
...
![1594776811158](http://bodiegu.lsgdut.fun/20200715093333-972226.png)
...
![1594821128208](http://bodiegu.lsgdut.fun/20200715215209-330421.png)
...
![1594821188387](http://bodiegu.lsgdut.fun/20200716135941-626948.png)
...
![1594821225708](http://bodiegu.lsgdut.fun/20200716135939-234417.png)
...
![1594825327345](http://bodiegu.lsgdut.fun/20200715230208-829688.png)
...
![1594826082009](http://bodiegu.lsgdut.fun/20200715231442-249345.png)

线程对应的cell已经创建好，则执行的是第二个红框里的代码，逻辑如下

![1594826936970](http://bodiegu.lsgdut.fun/20200715232859-416098.png)
